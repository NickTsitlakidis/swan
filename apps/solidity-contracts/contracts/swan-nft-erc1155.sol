...
import "./interfaces/swan-ierc1155.sol";
 ...
 */
contract ERC1155MixedFungible is Context, ERC1155, SwanIERC1155NFT {
    ...
    function supportsInterface(
        ...
        return
            interfaceId == type(SwanIERC1155NFT).interfaceId ||
    ...
    function uri(uint256 id) public view virtual override(SwanIERC1155NFT, ERC1155) returns (string memory) {
